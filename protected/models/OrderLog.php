...
class OrderLog extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('before, after, message, created', 'required'),
			array('order_id, admin_id, created', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, order_id, admin_id, before, after, message, created', 'safe', 'on'=>'search'),
		);
	}
