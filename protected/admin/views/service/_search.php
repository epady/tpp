...
<td>
<?php echo $form->dropdownlist($model, 'city_id',Area::options(0), array('empty' => '所有区域')); ?>
</td>
<td style="text-align:right;vertical-align:middle;">
	<?php echo $form->label($model,'dipian'); ?>
</td>
<td>
<?php echo $form->dropdownlist($model, 'dipian', Service::dipianOptions(), array( 'empty' => '全部')); ?>
</td>
